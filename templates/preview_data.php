<div id="preview_data_modal"data-bs-backdrop="static" data-keyboard="true" class="modal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered modal-confirm modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-options light-background modal-options-bottom">
        <span class="btn-modal-cancel">Cancel</span>
