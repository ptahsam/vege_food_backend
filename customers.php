...
<body>
	<div class="main-container">
		...
		<?php include_once("./templates/left_customersidebar.php");?>
				...
				<div class="infoContainer-body">
					<div class="infoContainer-body-actions">
						...
						<div class="infoContainer-body-actions-right">
							...
							<button class="btn btn-primary btn-sm" id="add_new_customer"><i class="fa-solid fa-plus"></i>Add New Customer</button>
						</div>
					</div>
...
<?php include_once("./templates/create_message.php");?>
<?php include_once("./templates/select_upload_customer_file.php");?>
<?php include_once("./templates/preview_customer_data.php");?>
<?php include_once("./templates/change_password.php");?>
<?php include_once("./templates/delete_modal.php");?>
<?php include_once("./templates/create_customer.php");?>
